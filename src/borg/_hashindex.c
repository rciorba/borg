 ...
 */
static int hash_sizes[] = { DEBUG_SIZES
...
static const void *hashindex_get_key(HashIndex *index, int bucket_idx);
static const void *hashindex_get_value(HashIndex *index, int bucket_idx);
...
static const void *
hashindex_get_key(HashIndex *index, int bucket_idx)
{
...
static const void *
hashindex_get_value(HashIndex *index, int bucket_idx)
{
    if(bucket_idx < 0 || bucket_idx >= index->num_buckets) {
        return NULL;
    }
